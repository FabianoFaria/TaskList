...
@interface TLCreateTaskViewController ()

@end

@implementation TLCreateTaskViewController
...
-(TLTasks *)returNewTaskObject
{
    TLTasks *taskObject = [[TLTasks alloc] init];
...
- (IBAction)createTaskBtnPress:(UIButton *)sender {
    ...
    [self.delegate createTask:[self returNewTaskObject]];
}
